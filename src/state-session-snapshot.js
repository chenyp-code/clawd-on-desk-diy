...
function sessionSnapshotSignature(snapshot) {
  return JSON.stringify({
    ...
    sessions: snapshot.sessions.map((entry) => ({
      ...
      lastTurnUsage: entry.lastTurnUsage,
      lastTurnCallCount: entry.lastTurnCallCount,
      lastAssistantEntryId: entry.lastAssistantEntryId,
      lastAssistantUsage: entry.lastAssistantUsage,
      sessionTokenUsage: entry.sessionTokenUsage,
      sessionCallCount: entry.sessionCallCount,
