...
const RELEASES_LATEST_URL = "https://github.com/chenyp-code/clawd-on-desk-diy/releases/latest";
...
function initUpdater(ctx, deps = {}) {
  ...
  function fetchLatestReleaseViaRedirect() {
    return new Promise((resolve, reject) => {
      const req = httpsGet({
        hostname: "github.com",
        path: "/chenyp-code/clawd-on-desk-diy/releases/latest",
        headers: {
  ...
  function fetchLatestReleaseFromApi() {
    return new Promise((resolve, reject) => {
      ...
      const req = httpsGet({
        ...
        path: "/repos/chenyp-code/clawd-on-desk-diy/releases/latest",
        headers,
      }, (res) => {
