...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      bubbleCompletionLabel: "Completion bubbles",
      bubbleCompletionDesc: "Shown when a Claude Code turn finishes. Bypasses DND and hideBubbles by policy so task finishes stay visible. Seconds controls how long they stay visible; 0 hides them.",
      ...
      rowIdleRoamingEnabled: "Idle desktop roaming",
      rowIdleRoamingEnabledDesc: "When you stop moving the cursor and no AI coding session is active, Clawd wanders the desktop on its own. Stops as soon as you move the mouse or a session starts.",
      rowSize: "Size",
      ...
      animOverridesSectionWalking: "Walking",
    ...
    zh: {
      ...
      bubbleCompletionLabel: "完成气泡",
      bubbleCompletionDesc: "Claude Code 任务完成时弹出。策略上绕过 DND 和 hideBubbles，确保完成提示不被吞掉。秒数控制停留时长，0 表示隐藏。",
      ...
      rowIdleRoamingEnabled: "桌面漫游",
      rowIdleRoamingEnabledDesc: "当鼠标静止且没有 AI 编程会话时，桌宠会自己在桌面上走动。一旦移动鼠标或启动会话，立即停止。",
      rowSize: "大小",
      ...
      animOverridesSectionWalking: "漫步",
    ...
    "zh-TW": {
      ...
      bubbleCompletionLabel: "完成對話框",
      bubbleCompletionDesc: "Claude Code 對話回合結束時顯示。策略上會繞過 DND 和 hideBubbles，確保完成提示不會被吞掉。秒數決定停留時間，0 表示隱藏。",
      bubbleSecondsPrefix: "停留",
      bubbleSecondsUnit: "秒",
      ...
      rowIdleRoamingEnabled: "桌面漫遊",
      rowIdleRoamingEnabledDesc: "當滑鼠靜止且沒有 AI 編碼工作階段時，桌寵會自己在桌面上走動。一旦移動滑鼠或啟動工作階段，立即停止。",
      rowSize: "大小",
    ...
    ko: {
      ...
      bubbleCompletionLabel: "완료 말풍선",
      bubbleCompletionDesc: "Claude Code 턴이 끝나면 표시됩니다. 정책상 DND와 hideBubbles를 우회하므로 완료 알림이 묻히지 않습니다. 초 값은 표시 시간, 0이면 숨깁니다.",
      ...
      rowIdleRoamingEnabled: "데스크탑 배회",
      rowIdleRoamingEnabledDesc: "마우스를 멈추고 AI 코딩 세션이 없을 때 Clawd가 데스크탑을 자유롭게 돌아다닙니다. 마우스를 움직이거나 세션이 시작되면 즉시 멈춥니다.",
      rowSize: "크기",
      ...
      animOverridesSectionWalking: "걷기",
    ...
    ja: {
      ...
      bubbleCompletionLabel: "完了吹き出し",
      bubbleCompletionDesc: "Claude Code のターンが終了したときに表示されます。ポリシーで DND と hideBubbles を回避するため、完了通知が埋もれません。秒数は表示時間、0 で非表示。",
      ...
      rowIdleRoamingEnabled: "デスクトップ漫遊",
      rowIdleRoamingEnabledDesc: "マウスを止め、AI コーディングセッションがない時、Clawd がデスクトップを自動で歩き回ります。マウスを動かすかセッションが始まるとすぐに停止します。",
      rowSize: "サイズ",
      ...
      animOverridesSectionWalking: "ウォーキング",
