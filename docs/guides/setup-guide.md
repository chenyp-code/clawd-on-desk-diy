...
> Thanks to [@Magic-Bytes](https://github.com/Magic-Bytes) for the original SSH tunneling idea ([#9](https://github.com/chenyp-code/clawd-on-desk-diy/issues/9)).
...
- **Packages**: AppImage and `.deb` are available from [GitHub Releases](https://github.com/chenyp-code/clawd-on-desk-diy/releases). After deb install, the app icon appears in GNOME's app menu.
